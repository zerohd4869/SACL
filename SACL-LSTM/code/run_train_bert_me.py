...
def train_or_eval_model(model, loss_f, dataloader, epoch=0, train_flag=False, optimizer=None, cuda_flag=False, feature_type='text', target_names=None,
                        ...
                        eval_cluster_flag=False, gradient_accumulation_steps=2):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='../data/meld/meld_features_roberta.pkl', help='dataset dir: MELD_features_raw.pkl')
    ...
    parser.add_argument('--step_p', type=int, default=1, help='the number of reason turns at speaker-level,0')
    ...
    parser.add_argument('--scl_w2', type=float, default=0.05, help='contrastive_weight 0.01/0.1/1')
    ...
    parser.add_argument('--situ_rate', type=float, default=0.1, help='at_rate 0.1/0.5/1')
    ...
    if status == 'train':
        ...
        for e in range(epochs):
            ...
            train_loss, train_acc, train_fscore, _, _ = train_or_eval_model(model=model, loss_f=loss_f, dataloader=train_loader, epoch=e, train_flag=True,
                                                                            ...
                                                                            target_names=target_names, contrast_hidden_flag=contrast_hidden_flag,
                                                                            contrast_weight=contrast_weight, contrast_weight2=contrast_weight2,
                                                                            adversary_flag=adversary_flag, adv_trainer=adv_trainer, at_method=at_method,
                                                                            at_rate=at_rate, situ_rate=args.situ_rate, speaker_rate=args.speaker_rate,
